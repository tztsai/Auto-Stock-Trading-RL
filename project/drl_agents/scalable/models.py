...
from .seed_rl.agents.vtrace.networks import ImpalaDeep as VTraceModel
...
class DRLAgent:
    ...
    def __init__(self, env: gym.Env, price_array, tech_array, turbulence_array):
        self.env = env
    ...
    def train_model(self, model, total_env_frames=int(1e9)):
        FLAGS.total_env_frames = total_env_frames
    ...
    def DRL_prediction(model_path, environment):
        ...
        while not done:
            action = model.predict(state)[0]  # FIXME
